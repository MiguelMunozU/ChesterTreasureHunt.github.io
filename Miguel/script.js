            ...
            if (submitAnswer) {
                submitAnswer.addEventListener('click', () => {
                    ...
                    if (answer === randomQuestion.answer) {
                        ...
                        if (contar === 3) {
                            alert("Congratulations! you've proved to be worthy of Chester's treasure");
                            window.location.href = 'win.html';
                        } else {
                            const nextRiddle = getRandomRiddle();
                            alert("Correct! Here is your next clue: " + nextRiddle);
                        ...
                        // Mostrar alerta con las vidas restantes
                        if (lives <= 0) {
                            alert(`Incorrect! You have no lives left. Game Over.`);
                            window.location.href = 'loose.html';
                        } else {
                            alert(`Incorrect! You have ${lives} lives left. Choose another place on the map.`);
                            window.location.href = 'map.html';
